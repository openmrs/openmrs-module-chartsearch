...
<openmrs:require privilege="Manage Global Properties" otherwise="/login.htm" redirect="/module/chartsearch/settings.form" />
...
<h2>Chart search settings
<!-- <spring:message code="webservices.rest.manage.settings.title" /> -->
</h2>
